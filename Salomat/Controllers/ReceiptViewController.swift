...
//            uiView2.leadingAnchor.constraint(equalTo: or.trailingAnchor, constant: 5),
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        let cell = receiptCollectionView.dequeueReusableCell(withReuseIdentifier: PhotoCollectionViewCell.identifier, for: IndexPath.init()) as! PhotoCollectionViewCell
        cell.photo.image = info[UIImagePickerController.InfoKey.editedImage] as? UIImage
